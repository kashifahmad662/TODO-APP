...
class EditTOTOList extends StatefulWidget {
  ...
  @override
  _EditTOTOListState createState() => _EditTOTOListState();
}

class _EditTOTOListState extends State<EditTOTOList> {
  ...
  void initState() {
    ...
    ChoosentileColor = Color(int.parse(widget.colorData));
    colorSecetedIndex = widget.colorIndex;
  ...
  Widget build(BuildContext context) {
    pages = [EditPage(), colorPicker(update: _new)];
                          ...
                          InkWell(
                              ...
                              child: ListTile(
                                ...
                                trailing: Row(
                                  ...
                                  children: [
                                    Text(
                                      "${(times.hour > 12) ? times.hour - 12 : times.hour}:${(times.minute < 10) ? "0" + (times.minute).toString() : times.minute}",
                                      style: TextStyle(
                                          color: Colors.black54,
                                          fontSize: 15.0),
                                    ),
